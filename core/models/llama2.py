...
Ported from refusal_direction/pipeline/model_utils/llama2_model.py
"""
...
class Llama2Model(ModelBase):
    ...
    def _get_eoi_toks(self):
        return self.tokenizer.encode(
            LLAMA2_CHAT_TEMPLATE.split("{instruction}")[-1], 
    ...
    def _get_o_proj_modules(self):
        return torch.nn.ModuleList([
            block_module.self_attn.o_proj for block_module in self.model_block_modules
        ])
