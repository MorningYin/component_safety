...
from src.classifier_models.refusal_component_classifier import RefusalComponentClassifier
...
def load_classifier_model(model_name: str, **kwargs) -> SafetyClassifierBase:
    ...
    elif model_name == "RefusalComponentClassifier":
        return RefusalComponentClassifier(**kwargs)
